"""Test CpraGrch37Annotator class with chr7:139086935 T>C."""
...
class CpraGrch37AnnotatorChr7_139086935_T_C_TestCase(unittest.TestCase):
    """Test CpraGrch37Annotator class with chr7:139086935 T>C."""
    ...
    def setUpClass(cls) -> None:
        super().setUpClass()
        config = TestConfig()
        cpra = Cpra(chrom="chr7", pos=139086935, ref="T", alt="C")
    ...
    def test_hgvs_annotation_hgvs_g_normalized(self):
        ...
        self.assertEqual(
            str(self.hgvs_annotation.hgvs_g_normalized), "NC_000007.13:g.139086935T>C"
        )
