"""Test CpraGrch37Annotator class with chr7:50358659 T>C."""
...
class CpraGrch37AnnotatorChr7_50358659_T_C_TestCase(unittest.TestCase):
    """Test CpraGrch37Annotator class with chr7:50358659 T>C."""
    ...
    def setUpClass(cls) -> None:
        super().setUpClass()
        config = TestConfig()
        cpra = Cpra(chrom="chr7", pos=50358659, ref="T", alt="C")
