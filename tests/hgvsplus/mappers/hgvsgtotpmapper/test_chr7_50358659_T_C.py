"""Test HgvsGToTPMapper class with chr7:50358659 T>C."""
...
class HgvsGToTPMapperChr7_50358659_T_CTestCase(unittest.TestCase):
    """Test HgvsGToTPMapper class with chr7:50358659 T>C."""

    @classmethod
    def setUpClass(cls) -> None:
        super().setUpClass()
        sequence_variant_g = parse("NC_000007.13:g.50358659T>C")
        hgvs_g = HgvsG.from_sequence_variant_g(sequence_variant_g=sequence_variant_g)
        tx_ac = "NM_001291841.1"
