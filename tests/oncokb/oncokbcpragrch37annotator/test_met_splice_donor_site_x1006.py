"""Test OncokbCpraGrch37Annotator class with MET splice donor site X1006"""
...
class OncokbCpraGrch37AnnotatorMetSpliceDonorSiteX1006TestCase(
    ...
    def setUpClass(cls) -> None:
        ...
        cls.query_alteration = "X1006_splice"
