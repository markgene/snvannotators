"""Test OncokbCpraGrch37Annotator class with MET splice donor site X1007"""
...
class OncokbCpraGrch37AnnotatorMetSpliceDonorSiteX1007TestCase(
    ...
    def setUpClass(cls) -> None:
        ...
        cls.query_alteration = "X1007_splice"
