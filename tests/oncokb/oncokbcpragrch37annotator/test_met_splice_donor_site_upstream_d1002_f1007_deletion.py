...
In-frame deletions affecting the splice sites flanking MET exon 14 result.
"""
import unittest
...
class OncokbCpraGrch37AnnotatorMetSpliceDonorSiteUpstreamD1002F1007DelTestCase(
    ...
    def setUpClass(cls) -> None:
        ...
        cls.query_alteration = "D1002_F1007del"
